...
function checkAvailability(page,divid,expense,str)
{
    var uname = document.getElementById(expense).value;
    if(uname == '')
    {
        document.getElementById(expense).style.border = '1px solid #ff0000';
